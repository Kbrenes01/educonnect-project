...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2026 a las 17:11:25
...
--
-- Estructura de tabla para la tabla `gibbonaction`
--
...
--
-- Volcado de datos para la tabla `gibbonaction`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivity`
--
...
CREATE TABLE `gibbonactivity` (
  ...
  `paymentDescription` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonactivityattendance`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivitycategory`
--
...
CREATE TABLE `gibbonactivitycategory` (
  ...
  `signUpChoices` int(11) NOT NULL DEFAULT 3,
...
--
-- Estructura de tabla para la tabla `gibbonactivitychoice`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivityphoto`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivityslot`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivitystaff`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivitystudent`
--
...
--
-- Estructura de tabla para la tabla `gibbonactivitytype`
--
...
CREATE TABLE `gibbonactivitytype` (
  ...
  `maxPerStudent` int(11) NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `gibbonadmissionsaccount`
--
...
--
-- Estructura de tabla para la tabla `gibbonadmissionsapplication`
--
...
--
-- Estructura de tabla para la tabla `gibbonalarm`
--
...
--
-- Estructura de tabla para la tabla `gibbonalarmconfirm`
--
...
--
-- Estructura de tabla para la tabla `gibbonalert`
--
...
--
-- Estructura de tabla para la tabla `gibbonalertlevel`
--
...
--
-- Volcado de datos para la tabla `gibbonalertlevel`
--
...
--
-- Estructura de tabla para la tabla `gibbonalerttype`
--
...
CREATE TABLE `gibbonalerttype` (
  ...
  `description` text DEFAULT NULL,
  `thresholdLow` int(11) DEFAULT NULL,
  `thresholdMed` int(11) DEFAULT NULL,
  `thresholdHigh` int(11) DEFAULT NULL,
  `sequenceNumber` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `gibbonalerttype`
--
...
--
-- Estructura de tabla para la tabla `gibbonapplicationform`
--
...
CREATE TABLE `gibbonapplicationform` (
  ...
  `email` varchar(75) DEFAULT NULL,
  `homeAddress` mediumtext DEFAULT NULL,
  ...
  `languageChoiceExperience` text DEFAULT NULL,
  ...
  `gibbonFinanceFeeCategoryIDList` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonapplicationformfile`
--
...
--
-- Estructura de tabla para la tabla `gibbonapplicationformlink`
--

CREATE TABLE `gibbonapplicationformlink` (
  `gibbonApplicationFormLinkID` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonapplicationformrelationship`
--
...
--
-- Estructura de tabla para la tabla `gibbonattendancecode`
--
...
--
-- Volcado de datos para la tabla `gibbonattendancecode`
--
...
--
-- Estructura de tabla para la tabla `gibbonattendancelogcourseclass`
--
...
--
-- Estructura de tabla para la tabla `gibbonattendancelogformgroup`
--
...
--
-- Estructura de tabla para la tabla `gibbonattendancelogperson`
--
...
--
-- Estructura de tabla para la tabla `gibbonbehaviour`
--
...
--
-- Estructura de tabla para la tabla `gibbonbehaviourfollowup`
--
...
--
-- Estructura de tabla para la tabla `gibbonbehaviourletter`
--
...
CREATE TABLE `gibbonbehaviourletter` (
  ...
  `recordCountAtCreation` int(11) NOT NULL,
  `body` text NOT NULL,
...
--
-- Estructura de tabla para la tabla `gibboncalendar`
--
...
--
-- Estructura de tabla para la tabla `gibboncalendareditor`
--
...
--
-- Estructura de tabla para la tabla `gibboncalendarevent`
--
...
--
-- Estructura de tabla para la tabla `gibboncalendareventperson`
--
...
--
-- Estructura de tabla para la tabla `gibboncalendareventtype`
--
...
--
-- Volcado de datos para la tabla `gibboncalendareventtype`
--
...
--
-- Estructura de tabla para la tabla `gibboncountry`
--
...
--
-- Volcado de datos para la tabla `gibboncountry`
--
...
--
-- Estructura de tabla para la tabla `gibboncourse`
--
...
--
-- Estructura de tabla para la tabla `gibboncourseclass`
--
...
CREATE TABLE `gibboncourseclass` (
  ...
  `enrolmentMin` int(11) DEFAULT NULL,
  `enrolmentMax` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibboncourseclassmap`
--
...
--
-- Estructura de tabla para la tabla `gibboncourseclassperson`
--
...
--
-- Estructura de tabla para la tabla `gibboncrowdassessdiscuss`
--
...
--
-- Estructura de tabla para la tabla `gibboncustomfield`
--
...
--
-- Estructura de tabla para la tabla `gibbondataretention`
--
...
--
-- Estructura de tabla para la tabla `gibbondaysofweek`
--
...
--
-- Volcado de datos para la tabla `gibbondaysofweek`
--
...
--
-- Estructura de tabla para la tabla `gibbondepartment`
--
...
--
-- Estructura de tabla para la tabla `gibbondepartmentresource`
--
...
--
-- Estructura de tabla para la tabla `gibbondepartmentstaff`
--
...
--
-- Estructura de tabla para la tabla `gibbondiscussion`
--
...
CREATE TABLE `gibbondiscussion` (
  ...
  `attachmentLocation` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbondistrict`
--
...
--
-- Estructura de tabla para la tabla `gibbonemailtemplate`
--
...
--
-- Volcado de datos para la tabla `gibbonemailtemplate`
--
...
--
-- Estructura de tabla para la tabla `gibbonexternalassessment`
--
...
--
-- Volcado de datos para la tabla `gibbonexternalassessment`
--
...
--
-- Estructura de tabla para la tabla `gibbonexternalassessmentfield`
--
...
--
-- Volcado de datos para la tabla `gibbonexternalassessmentfield`
--
...
--
-- Estructura de tabla para la tabla `gibbonexternalassessmentstudent`
--
...
--
-- Estructura de tabla para la tabla `gibbonexternalassessmentstudententry`
--
...
--
-- Estructura de tabla para la tabla `gibbonfamily`
--
...
--
-- Estructura de tabla para la tabla `gibbonfamilyadult`
--
...
CREATE TABLE `gibbonfamilyadult` (
  ...
  `contactPriority` int(11) NOT NULL DEFAULT 1,
...
--
-- Estructura de tabla para la tabla `gibbonfamilychild`
--
...
--
-- Estructura de tabla para la tabla `gibbonfamilyrelationship`
--
...
CREATE TABLE `gibbonfamilyrelationship` (
  ...
  `relationship` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Person 1 is [relationship] to person 2?';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonfamilyupdate`
--
...
--
-- Estructura de tabla para la tabla `gibbonfileextension`
--
...
--
-- Volcado de datos para la tabla `gibbonfileextension`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancebillingschedule`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancebudget`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancebudgetcycle`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancebudgetcycleallocation`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancebudgetperson`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinanceexpense`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinanceexpenseapprover`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinanceexpenselog`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancefee`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancefeecategory`
--
...
--
-- Volcado de datos para la tabla `gibbonfinancefeecategory`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinanceinvoice`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinanceinvoicee`
--
...
CREATE TABLE `gibbonfinanceinvoicee` (
  ...
  `gibbonFinanceFeeCategoryIDList` text DEFAULT NULL COMMENT 'If companyAll is N, list category IDs for campany to pay here.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonfinanceinvoiceeupdate`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinanceinvoicefee`
--
...
--
-- Estructura de tabla para la tabla `gibbonfinancepettycash`
--
...
CREATE TABLE `gibbonfinancepettycash` (
  ...
  `gibbonPersonID` int(11) NOT NULL,
  `amount` decimal(12,2) NOT NULL,
  `reason` varchar(90) DEFAULT NULL,
  `notes` text DEFAULT NULL,
  `gibbonPersonIDCreated` int(11) DEFAULT NULL,
  `timestampCreated` timestamp NULL DEFAULT NULL,
  `actionRequired` varchar(60) DEFAULT NULL,
  `gibbonPersonIDStatus` int(11) DEFAULT NULL,
  `timestampStatus` timestamp NULL DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonfirstaid`
--
...
--
-- Estructura de tabla para la tabla `gibbonfirstaidfollowup`
--
...
--
-- Estructura de tabla para la tabla `gibbonform`
--
...
--
-- Volcado de datos para la tabla `gibbonform`
--
...
--
-- Estructura de tabla para la tabla `gibbonformfield`
--
...
CREATE TABLE `gibbonformfield` (
  ...
  `description` text DEFAULT NULL,
  `conditional` text DEFAULT NULL COMMENT 'json',
  `defaultValue` varchar(255) DEFAULT NULL,
  `sequenceNumber` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `gibbonformfield`
--
...
--
-- Estructura de tabla para la tabla `gibbonformgroup`
--
...
--
-- Estructura de tabla para la tabla `gibbonformpage`
--
...
--
-- Volcado de datos para la tabla `gibbonformpage`
--
...
--
-- Estructura de tabla para la tabla `gibbonformsubmission`
--
...
--
-- Estructura de tabla para la tabla `gibbonformupload`
--
...
--
-- Estructura de tabla para la tabla `gibbongroup`
--
...
--
-- Estructura de tabla para la tabla `gibbongroupperson`
--
...
--
-- Estructura de tabla para la tabla `gibbonhook`
--
...
--
-- Estructura de tabla para la tabla `gibbonhouse`
--
...
--
-- Estructura de tabla para la tabla `gibboni18n`
--
...
--
-- Volcado de datos para la tabla `gibboni18n`
--
...
(0003, 'es_ES', 'Español - España', '30.0.01', 'Y', 'Y', 'Y', 'dd/mm/yyyy', '/^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d$/i', 'd/m/Y', 'N'),
...
(0015, 'pt_PT', 'Português', NULL, 'Y', 'N', 'N', 'dd/mm/yyyy', '/^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d$/i', 'd/m/Y', 'N'),
(0016, 'ro_RO', 'Română', NULL, 'Y', 'N', 'N', 'dd.mm.yyyy', '/^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d$/i', 'd.m.Y', 'N'),
(0017, 'ja_JP', '日本語', NULL, 'Y', 'N', 'N', 'yyyy-mm-dd', '/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/', 'Y-m-d', 'N'),
...
--
-- Estructura de tabla para la tabla `gibbonin`
--
...
--
-- Estructura de tabla para la tabla `gibboninarchive`
--
...
--
-- Estructura de tabla para la tabla `gibboninassistant`
--
...
--
-- Estructura de tabla para la tabla `gibbonindescriptor`
--
...
--
-- Volcado de datos para la tabla `gibbonindescriptor`
--
...
--
-- Estructura de tabla para la tabla `gibbonininvestigation`
--
...
CREATE TABLE `gibbonininvestigation` (
  ...
  `parentsResponse` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonininvestigationcontribution`
--
...
CREATE TABLE `gibbonininvestigationcontribution` (
  ...
  `status` enum('Pending','Complete') NOT NULL DEFAULT 'Pending',
  `cognition` text DEFAULT NULL,
  `memory` text DEFAULT NULL,
  `selfManagement` text DEFAULT NULL,
  `attention` text DEFAULT NULL,
  `socialInteraction` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibboninpersondescriptor`
--
...
--
-- Estructura de tabla para la tabla `gibboninternalassessmentcolumn`
--
...
--
-- Estructura de tabla para la tabla `gibboninternalassessmententry`
--
...
--
-- Estructura de tabla para la tabla `gibbonlanguage`
--
...
--
-- Volcado de datos para la tabla `gibbonlanguage`
--
...
--
-- Estructura de tabla para la tabla `gibbonlibraryitem`
--

CREATE TABLE `gibbonlibraryitem` (
  `gibbonLibraryItemID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `gibbonLibraryItemIDParent` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonlibraryitemevent`
--
...
--
-- Estructura de tabla para la tabla `gibbonlibraryshelf`
--
...
--
-- Estructura de tabla para la tabla `gibbonlibraryshelfitem`
--
...
--
-- Estructura de tabla para la tabla `gibbonlibrarytype`
--
...
--
-- Volcado de datos para la tabla `gibbonlibrarytype`
--
...
--
-- Estructura de tabla para la tabla `gibbonlog`
--
...
CREATE TABLE `gibbonlog` (
  ...
  `serialisedArray` text DEFAULT NULL,
  `ip` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `gibbonlog`
--
...
(0000000000000001, NULL, 0000000001, 025, '2026-05-27 22:04:40', 'Login - Success', 'a:3:{s:8:\"username\";s:5:\"admin\";s:6:\"method\";s:7:\"Default\";s:6:\"reason\";s:0:\"\";}', '::1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonmarkbookcolumn`
--
...
--
-- Estructura de tabla para la tabla `gibbonmarkbookentry`
--
...
--
-- Estructura de tabla para la tabla `gibbonmarkbooktarget`
--
...
--
-- Estructura de tabla para la tabla `gibbonmarkbookweight`
--
...
--
-- Estructura de tabla para la tabla `gibbonmedicalcondition`
--
...
--
-- Volcado de datos para la tabla `gibbonmedicalcondition`
--
...
--
-- Estructura de tabla para la tabla `gibbonmessenger`
--
...
CREATE TABLE `gibbonmessenger` (
  ...
  `emailReceiptText` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonmessengercannedresponse`
--
...
--
-- Estructura de tabla para la tabla `gibbonmessengermailinglist`
--
...
--
-- Estructura de tabla para la tabla `gibbonmessengermailinglistrecipient`
--
...
CREATE TABLE `gibbonmessengermailinglistrecipient` (
  ...
  `gibbonMessengerMailingListIDList` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonmessengerreceipt`
--
...
CREATE TABLE `gibbonmessengerreceipt` (
  ...
  `gibbonPersonIDListStudent` text DEFAULT NULL,
  `nameListStudent` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonmessengertarget`
--
...
--
-- Estructura de tabla para la tabla `gibbonmigration`
--
...
--
-- Estructura de tabla para la tabla `gibbonmodule`
--
...
--
-- Volcado de datos para la tabla `gibbonmodule`
--
...
--
-- Estructura de tabla para la tabla `gibbonnotification`
--
...
--
-- Estructura de tabla para la tabla `gibbonnotificationevent`
--
...
--
-- Volcado de datos para la tabla `gibbonnotificationevent`
--
...
--
-- Estructura de tabla para la tabla `gibbonnotificationlistener`
--
...
--
-- Estructura de tabla para la tabla `gibbonoutcome`
--
...
--
-- Estructura de tabla para la tabla `gibbonpayment`
--
...
--
-- Estructura de tabla para la tabla `gibbonpermission`
--
...
--
-- Volcado de datos para la tabla `gibbonpermission`
--
...
--
-- Estructura de tabla para la tabla `gibbonperson`
--
...
CREATE TABLE `gibbonperson` (
  ...
  `studentAgreements` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonpersonaldocumenttype`
--
...
--
-- Volcado de datos para la tabla `gibbonpersonaldocumenttype`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonmedical`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonmedicalcondition`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonmedicalconditionupdate`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonmedicalupdate`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonphoto`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonreset`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonstatuslog`
--
...
--
-- Estructura de tabla para la tabla `gibbonpersonupdate`
--
...
--
-- Estructura de tabla para la tabla `gibbonplannerentry`
--
...
CREATE TABLE `gibbonplannerentry` (
  ...
  `homeworkTimeCap` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonplannerentrydiscuss`
--
...
--
-- Estructura de tabla para la tabla `gibbonplannerentryguest`
--
...
--
-- Estructura de tabla para la tabla `gibbonplannerentryhomework`
--
...
--
-- Estructura de tabla para la tabla `gibbonplannerentryoutcome`
--
...
--
-- Estructura de tabla para la tabla `gibbonplannerentrystudenthomework`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Allows students to add homework deadlines themselves';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonplannerentrystudenttracker`
--
...
--
-- Estructura de tabla para la tabla `gibbonplannerparentweeklyemailsummary`
--
...
--
-- Estructura de tabla para la tabla `gibbonreport`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportarchive`
--
...
--
-- Volcado de datos para la tabla `gibbonreportarchive`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportarchiveentry`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingaccess`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingcriteria`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingcriteriatype`
--
...
--
-- Volcado de datos para la tabla `gibbonreportingcriteriatype`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingcycle`
--
...
CREATE TABLE `gibbonreportingcycle` (
  ...
  `cycleTotal` int(11) DEFAULT NULL,
  `dateStart` date DEFAULT NULL,
  `dateEnd` date DEFAULT NULL,
  `milestones` text DEFAULT NULL,
  `notes` text DEFAULT NULL
...
--
-- Estructura de tabla para la tabla `gibbonreportingprogress`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingproof`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingscope`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportingvalue`
--
...
--
-- Estructura de tabla para la tabla `gibbonreportprototypesection`
--
...
CREATE TABLE `gibbonreportprototypesection` (
  ...
  `config` text DEFAULT NULL,
  `templateParams` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonreporttemplate`
--
...
--
-- Estructura de tabla para la tabla `gibbonreporttemplatefont`
--
...
--
-- Estructura de tabla para la tabla `gibbonreporttemplatesection`
--
...
--
-- Estructura de tabla para la tabla `gibbonresource`
--
...
--
-- Estructura de tabla para la tabla `gibbonresourcetag`
--
...
--
-- Estructura de tabla para la tabla `gibbonrole`
--
...
--
-- Volcado de datos para la tabla `gibbonrole`
--
...
--
-- Estructura de tabla para la tabla `gibbonrubric`
--
...
--
-- Estructura de tabla para la tabla `gibbonrubriccell`
--
...
--
-- Estructura de tabla para la tabla `gibbonrubriccolumn`
--
...
--
-- Estructura de tabla para la tabla `gibbonrubricentry`
--
...
--
-- Estructura de tabla para la tabla `gibbonrubricrow`
--
...
--
-- Estructura de tabla para la tabla `gibbonscale`
--
...
--
-- Volcado de datos para la tabla `gibbonscale`
--
...
--
-- Estructura de tabla para la tabla `gibbonscalegrade`
--
...
--
-- Volcado de datos para la tabla `gibbonscalegrade`
--
...
--
-- Estructura de tabla para la tabla `gibbonschoolyear`
--
...
--
-- Volcado de datos para la tabla `gibbonschoolyear`
--
...
--
-- Estructura de tabla para la tabla `gibbonschoolyearspecialday`
--
...
--
-- Estructura de tabla para la tabla `gibbonschoolyearterm`
--
...
--
-- Volcado de datos para la tabla `gibbonschoolyearterm`
--
...
--
-- Estructura de tabla para la tabla `gibbonsession`
--
...
CREATE TABLE `gibbonsession` (
  ...
  `sessionData` mediumtext DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `gibbonsession`
--

INSERT INTO `gibbonsession` (`gibbonSessionID`, `gibbonPersonID`, `gibbonActionID`, `sessionData`, `sessionStatus`, `timestampCreated`, `timestampModified`) VALUES
('9o531g6p0i14ebqqg599ssdkf2', NULL, NULL, NULL, NULL, '2026-05-28 04:42:10', '2026-05-28 04:42:10'),
('r5ba8n9f4q2qpghvvhm411la8j', 0000000001, NULL, NULL, 'Logged In', '2026-05-27 22:04:40', '2026-05-27 22:05:03');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonsetting`
--
...
--
-- Volcado de datos para la tabla `gibbonsetting`
--

INSERT INTO `gibbonsetting` (`gibbonSettingID`, `scope`, `name`, `nameDisplay`, `description`, `value`) VALUES
(00001, 'System', 'absoluteURL', 'Base URL', 'The address at which the whole system resides.', 'http://localhost\\educonnect'),
(00002, 'System', 'organisationName', 'Organisation Name', '', 'Educonnect'),
(00003, 'System', 'organisationNameShort', 'Organisation Initials', '', 'EDC'),
...
(00009, 'System', 'absolutePath', 'Base Path', 'The local FS path to the system', 'C:\\xampp\\htdocs\\educonnect'),
(00011, 'System', 'timezone', 'Timezone', 'The timezone where the school is located', 'America/Costa_Rica'),
...
(00021, 'System', 'country', 'Country', 'The country the school is located in', 'Costa Rica'),
...
(00039, 'System', 'version', 'Version', 'The version of the Gibbon database', '30.0.01'),
...
(00041, 'System', 'organisationEmail', 'Organisation Email', 'General email address for the school', 'kbrenesleiv@gmail.com'),
(00042, 'Activities', 'dateType', 'Date Type', 'Should activities be organised around dates (flexible) or terms (easy)?', 'Term'),
(00043, 'System', 'installType', 'Install Type', 'The purpose of this installation of Gibbon', 'Testing'),
...
(00109, 'Finance', 'email', 'Email', 'Email address to send finance emails from.', 'kbrenesleiv@gmail.com'),
...
(00328, 'System', 'registerGibbonSupport', 'Receive Support?', 'Join our mailing list and recieve a welcome email from the team.', 'Y');
INSERT INTO `gibbonsetting` (`gibbonSettingID`, `scope`, `name`, `nameDisplay`, `description`, `value`) VALUES
...
--
-- Estructura de tabla para la tabla `gibbonspace`
--
...
CREATE TABLE `gibbonspace` (
  ...
  `computerStudent` int(11) NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `gibbonspaceperson`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaff`
--
...
CREATE TABLE `gibbonstaff` (
  ...
  `biographicalGroupingPriority` int(11) NOT NULL,
  `coverageExclude` enum('N','Y') NOT NULL DEFAULT 'N',
  `coveragePriority` int(11) DEFAULT 0,
  `fields` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `gibbonstaff`
--

INSERT INTO `gibbonstaff` (`gibbonStaffID`, `gibbonPersonID`, `type`, `initials`, `jobTitle`, `firstAidQualified`, `firstAidQualification`, `firstAidExpiry`, `countryOfOrigin`, `qualifications`, `biography`, `biographicalGrouping`, `biographicalGroupingPriority`, `coverageExclude`, `coveragePriority`, `fields`) VALUES
(0000000001, 0000000001, 'Teaching', NULL, '', '', NULL, NULL, '', '', '', '', 0, 'N', 0, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gibbonstaffabsence`
--
...
CREATE TABLE `gibbonstaffabsence` (
  ...
  `comment` text DEFAULT NULL,
  `commentConfidential` text DEFAULT NULL,
  ...
  `notesApproval` text DEFAULT NULL,
  `gibbonPersonIDCreator` int(10) UNSIGNED ZEROFILL NOT NULL,
  `timestampCreator` timestamp NOT NULL DEFAULT current_timestamp(),
  `notificationSent` enum('N','Y') DEFAULT 'N',
  `notificationList` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `gibbonstaffabsencedate`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffabsencetype`
--
...
--
-- Volcado de datos para la tabla `gibbonstaffabsencetype`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffapplicationform`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffapplicationformfile`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffcontract`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffcoverage`
--
...
CREATE TABLE `gibbonstaffcoverage` (
  ...
  `notesCoverage` text DEFAULT NULL,
  `attachmentType` enum('File','HTML','Link') DEFAULT NULL,
  `attachmentContent` text DEFAULT NULL,
  `notificationSent` enum('N','Y') DEFAULT 'N',
  `notificationList` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estructura de tabla para la tabla `gibbonstaffcoveragedate`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffduty`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffdutyperson`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffjobopening`
--
...
--
-- Estructura de tabla para la tabla `gibbonstaffupdate`
--
...
--
-- Estructura de tabla para la tabla `gibbonstring`
--
...
--
-- Estructura de tabla para la tabla `gibbonstudentenrolment`
--
...
--
-- Estructura de tabla para la tabla `gibbonstudentnote`
--
...
--
-- Estructura de tabla para la tabla `gibbonstudentnotecategory`
--
...
--
-- Volcado de datos para la tabla `gibbonstudentnotecategory`
--
...
--
-- Estructura de tabla para la tabla `gibbonsubstitute`
--
...
--
-- Estructura de tabla para la tabla `gibbontheme`
--
...
--
-- Volcado de datos para la tabla `gibbontheme`
--
...
--
-- Estructura de tabla para la tabla `gibbontt`
--
...
--
-- Estructura de tabla para la tabla `gibbonttcolumn`
--
...
--
-- Estructura de tabla para la tabla `gibbonttcolumnrow`
--
...
--
-- Estructura de tabla para la tabla `gibbonttday`
--
...
--
-- Estructura de tabla para la tabla `gibbonttdaydate`
--
...
--
-- Estructura de tabla para la tabla `gibbonttdayrowclass`
--
...
--
-- Estructura de tabla para la tabla `gibbonttdayrowclassexception`
--
...
--
-- Estructura de tabla para la tabla `gibbonttimport`
--
...
--
-- Estructura de tabla para la tabla `gibbonttspacebooking`
--
...
--
-- Estructura de tabla para la tabla `gibbonttspacechange`
--
...
--
-- Estructura de tabla para la tabla `gibbonunit`
--
...
--
-- Estructura de tabla para la tabla `gibbonunitblock`
--
...
--
-- Estructura de tabla para la tabla `gibbonunitclass`
--
...
--
-- Estructura de tabla para la tabla `gibbonunitclassblock`
--
...
--
-- Estructura de tabla para la tabla `gibbonunitoutcome`
--
...
--
-- Estructura de tabla para la tabla `gibbonusernameformat`
--
...
CREATE TABLE `gibbonusernameformat` (
  ...
  `numericValue` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `numericIncrement` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `numericSize` int(10) UNSIGNED NOT NULL DEFAULT 4
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `gibbonusernameformat`
--
...
--
-- Estructura de tabla para la tabla `gibbonyeargroup`
--
...
--
-- Volcado de datos para la tabla `gibbonyeargroup`
--
...
--
-- Indices de la tabla `gibbonaction`
--
...
--
-- Indices de la tabla `gibbonactivitychoice`
--
...
--
-- Indices de la tabla `gibbonactivitystudent`
--
...
--
-- Indices de la tabla `gibbonactivitytype`
--
...
--
-- Indices de la tabla `gibbonadmissionsaccount`
--
...
--
-- Indices de la tabla `gibbonadmissionsapplication`
--
...
--
-- Indices de la tabla `gibbonalarm`
--
ALTER TABLE `gibbonalarm`
  ADD PRIMARY KEY (`gibbonAlarmID`);

--
-- Indices de la tabla `gibbonalarmconfirm`
--
...
--
-- Indices de la tabla `gibbonalert`
--
...
--
-- Indices de la tabla `gibbonbehaviour`
--
...
--
-- Indices de la tabla `gibbonbehaviourfollowup`
--
...
--
-- Indices de la tabla `gibboncourseclass`
--
...
--
-- Indices de la tabla `gibboncourseclassmap`
--
...
--
-- Indices de la tabla `gibboncourseclassperson`
--
...
--
-- Indices de la tabla `gibbondaysofweek`
--
...
--
-- Indices de la tabla `gibbondistrict`
--
ALTER TABLE `gibbondistrict`
  ADD PRIMARY KEY (`gibbonDistrictID`);

--
-- Indices de la tabla `gibbonemailtemplate`
--
...
--
-- Indices de la tabla `gibbonexternalassessment`
--
ALTER TABLE `gibbonexternalassessment`
  ADD PRIMARY KEY (`gibbonExternalAssessmentID`);

--
-- Indices de la tabla `gibbonexternalassessmentfield`
--
...
--
-- Indices de la tabla `gibbonexternalassessmentstudent`
--
...
--
-- Indices de la tabla `gibbonexternalassessmentstudententry`
--
...
--
-- Indices de la tabla `gibbonfamily`
--
ALTER TABLE `gibbonfamily`
  ADD PRIMARY KEY (`gibbonFamilyID`);

--
-- Indices de la tabla `gibbonfamilyadult`
--
...
--
-- Indices de la tabla `gibbonfamilychild`
--
...
--
-- Indices de la tabla `gibbonfamilyrelationship`
--
ALTER TABLE `gibbonfamilyrelationship`
  ADD PRIMARY KEY (`gibbonFamilyRelationshipID`);

--
-- Indices de la tabla `gibbonfamilyupdate`
--
...
--
-- Indices de la tabla `gibbonfinancebudgetcycle`
--
...
--
-- Indices de la tabla `gibbonformupload`
--
...
--
-- Indices de la tabla `gibbongroup`
--
ALTER TABLE `gibbongroup`
  ADD PRIMARY KEY (`gibbonGroupID`);

--
-- Indices de la tabla `gibbongroupperson`
--
...
--
-- Indices de la tabla `gibbonhook`
--
...
--
-- Indices de la tabla `gibbonhouse`
--
...
--
-- Indices de la tabla `gibboni18n`
--
ALTER TABLE `gibboni18n`
  ADD PRIMARY KEY (`gibboni18nID`);

--
-- Indices de la tabla `gibbonin`
--
...
--
-- Indices de la tabla `gibbonmarkbookentry`
--
...
--
-- Indices de la tabla `gibbonmarkbooktarget`
--
...
--
-- Indices de la tabla `gibbonmarkbookweight`
--
ALTER TABLE `gibbonmarkbookweight`
  ADD PRIMARY KEY (`gibbonMarkbookWeightID`);

--
-- Indices de la tabla `gibbonmedicalcondition`
--
...
--
-- Indices de la tabla `gibbonmessengerreceipt`
--
...
--
-- Indices de la tabla `gibbonmessengertarget`
--
...
--
-- Indices de la tabla `gibbonmigration`
--
ALTER TABLE `gibbonmigration`
  ADD PRIMARY KEY (`gibbonMigrationID`);

--
-- Indices de la tabla `gibbonmodule`
--
...
--
-- Indices de la tabla `gibbonnotification`
--
...
--
-- Indices de la tabla `gibbonnotificationevent`
--
...
--
-- Indices de la tabla `gibbonperson`
--
...
--
-- Indices de la tabla `gibbonpersonaldocument`
--
...
--
-- Indices de la tabla `gibbonpersonaldocumenttype`
--
ALTER TABLE `gibbonpersonaldocumenttype`
  ADD PRIMARY KEY (`gibbonPersonalDocumentTypeID`);

--
-- Indices de la tabla `gibbonpersonmedical`
--
...
--
-- Indices de la tabla `gibbonpersonmedicalcondition`
--
...
--
-- Indices de la tabla `gibbonpersonmedicalconditionupdate`
--
ALTER TABLE `gibbonpersonmedicalconditionupdate`
  ADD PRIMARY KEY (`gibbonPersonMedicalConditionUpdateID`);

--
-- Indices de la tabla `gibbonpersonmedicalupdate`
--
...
--
-- Indices de la tabla `gibbonpersonphoto`
--
...
--
-- Indices de la tabla `gibbonpersonreset`
--
ALTER TABLE `gibbonpersonreset`
  ADD PRIMARY KEY (`gibbonPersonResetID`);

--
-- Indices de la tabla `gibbonpersonstatuslog`
--
...
--
-- Indices de la tabla `gibbonpersonupdate`
--
...
--
-- Indices de la tabla `gibbonplannerentry`
--
...
--
-- Indices de la tabla `gibbonplannerentrystudenttracker`
--
ALTER TABLE `gibbonplannerentrystudenttracker`
  ADD PRIMARY KEY (`gibbonPlannerEntryStudentTrackerID`);

--
-- Indices de la tabla `gibbonplannerparentweeklyemailsummary`
--
...
--
-- Indices de la tabla `gibbonreportingcycle`
--
ALTER TABLE `gibbonreportingcycle`
  ADD PRIMARY KEY (`gibbonReportingCycleID`);

--
-- Indices de la tabla `gibbonreportingprogress`
--
...
--
-- Indices de la tabla `gibbonreportingproof`
--
...
--
-- Indices de la tabla `gibbonreportingscope`
--
ALTER TABLE `gibbonreportingscope`
  ADD PRIMARY KEY (`gibbonReportingScopeID`);

--
-- Indices de la tabla `gibbonreportingvalue`
--
...
--
-- Indices de la tabla `gibbonreportprototypesection`
--
...
--
-- Indices de la tabla `gibbonreporttemplate`
--
ALTER TABLE `gibbonreporttemplate`
  ADD PRIMARY KEY (`gibbonReportTemplateID`);

--
-- Indices de la tabla `gibbonreporttemplatefont`
--
...
--
-- Indices de la tabla `gibbonrole`
--
...
--
-- Indices de la tabla `gibbonrubric`
--
ALTER TABLE `gibbonrubric`
  ADD PRIMARY KEY (`gibbonRubricID`);

--
-- Indices de la tabla `gibbonrubriccell`
--
...
--
-- Indices de la tabla `gibbonrubriccolumn`
--
...
--
-- Indices de la tabla `gibbonrubricentry`
--
...
--
-- Indices de la tabla `gibbonrubricrow`
--
...
--
-- Indices de la tabla `gibbonschoolyearspecialday`
--
...
--
-- Indices de la tabla `gibbonschoolyearterm`
--
...
--
-- Indices de la tabla `gibbonsession`
--
ALTER TABLE `gibbonsession`
  ADD PRIMARY KEY (`gibbonSessionID`);

--
-- Indices de la tabla `gibbonsetting`
--
...
--
-- Indices de la tabla `gibbonspace`
--
...
--
-- Indices de la tabla `gibbonspaceperson`
--
ALTER TABLE `gibbonspaceperson`
  ADD PRIMARY KEY (`gibbonSpacePersonID`);

--
-- Indices de la tabla `gibbonstaff`
--
...
--
-- Indices de la tabla `gibbonstaffduty`
--
ALTER TABLE `gibbonstaffduty`
  ADD PRIMARY KEY (`gibbonStaffDutyID`);

--
-- Indices de la tabla `gibbonstaffdutyperson`
--
...
--
-- Indices de la tabla `gibbonttday`
--
ALTER TABLE `gibbonttday`
  ADD PRIMARY KEY (`gibbonTTDayID`);

--
-- Indices de la tabla `gibbonttdaydate`
--
...
--
-- Indices de la tabla `gibbonttdayrowclass`
--
